...
function SelectionTest() {
  ...
  ]), [navigateCharacter, navigateLine, navigateLineBoundary, navigateDocumentBoundary, selection, updateSelection, collapseSelection, resetBlink])
    ...
    switch (clickCount) {
      ...
      case 2: {
        ...
        if (caretPos.node.nodeType === Node.TEXT_NODE) {
          ...
          updateSelection(
            { node: textNode, offset: start },
            { node: textNode, offset: end }
          )
        }
        break
      }
  ...
  return (
    <div className="container">
      ...
      <div style={{ marginBottom: '20px', padding: '10px', background: '#f5f5f5', borderRadius: '5px' }}>
        <h3>Controls:</h3>
        <button onClick={selectAll} style={{ marginRight: '10px' }}>Select All (Ctrl+A)</button>
        <button onClick={clearSelection} style={{ marginRight: '10px' }}>Clear Selection (Esc)</button>
        
        <p style={{ margin: '10px 0', fontSize: '14px', color: '#666' }}>
          <strong>Atomic Components:</strong> Tables and HR elements (highlighted in blue) are treated as single units. 
          Try clicking on them or navigating through them with arrow keys.
        </p>
        
        <h4>Keyboard Shortcuts:</h4>
        <ul style={{ fontSize: '12px', margin: '5px 0' }}>
          <li><strong>Arrow Keys:</strong> Move cursor</li>
          <li><strong>Shift + Arrow Keys:</strong> Extend selection</li>
          <li><strong>Home/End:</strong> Move to line start/end</li>
          <li><strong>Shift + Home/End:</strong> Select to line start/end</li>
          <li><strong>Ctrl/Cmd + Arrow Keys:</strong> Move to word/document boundaries</li>
          <li><strong>Shift + Ctrl/Cmd + Arrow Keys:</strong> Extend selection to boundaries</li>
          <li><strong>Mouse:</strong> Click to position, drag to select</li>
          <li><strong>Shift + Click:</strong> Extend selection</li>
          <li><strong>Double Click:</strong> Select word</li>
          <li><strong>Triple Click:</strong> Select paragraph</li>
        </ul>
      </div>
      ...
      <div style={{ marginBottom: '20px', padding: '10px', background: '#e8f4f8', borderRadius: '5px' }}>
        ...
        <pre style={{ fontSize: '12px', margin: 0 }}>
          {JSON.stringify(getSelectionInfo(), null, 2)}
        </pre>
      </div>
      ...
      >
        ...
        <p>
          This is a test page for the enhanced <strong>useSelection</strong> hook. You can interact with this text using 
          various keyboard shortcuts and mouse operations.
        </p>
        
        <blockquote>
          Try different selection methods: use arrow keys with Shift to extend selection, 
          double-click to select words, triple-click to select paragraphs, and drag with the mouse.
        </blockquote>
        ...
        <p>
          The selection system now uses the enhanced <code>CaretPosition</code> class and <code>Selection</code> class 
          internally, providing rich functionality for cursor positioning and text selection management.
        </p>
        ...
        <p>
          You can use <strong>Ctrl+A</strong> (or <strong>Cmd+A</strong> on Mac) to select all text, 
          and <strong>Escape</strong> to clear the selection.
        </p>
        ...
        <p>
          The following elements are treated as <strong>atomic components</strong> - they behave as single units 
          that cannot be entered with the cursor. You can only position the cursor before or after them.
        </p>
        ...
        <p>
          Try clicking on the table above. Notice how the cursor can only be positioned at the beginning or end 
          of the table, not inside it. Use arrow keys to navigate around it.
        </p>

        <hr className="atomic-component" />

        <p>
          The horizontal rules (HR elements) above and below are also atomic components. 
          Try navigating through them with arrow keys or clicking near them.
        </p>
...
{`function example() {
  ...
  return result;
        ...
        <ol>
          ...
          <li><strong>Selection Tests:</strong>
            <ul>
        ...
        <p>
          Test navigation with <strong>Home</strong>/<strong>End</strong> keys to move to line boundaries, 
          and <strong>Ctrl+Home</strong>/<strong>Ctrl+End</strong> to move to document boundaries.
        </p>
      </div>
    </div>
  )
